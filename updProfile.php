   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="inputBox">
            ...
            <span>email :</span>
            <input type="email" name="email" value="<?= $fetch_profile['email']; ?>" placeholder="update email" required class="box" disabled>
      ...
      <div class="flex-btn">
         ...
         <a href="homepage.php" class="option-btn">go back</a>
      </div>
   </form>
