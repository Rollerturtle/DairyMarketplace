    ...
    if(isset($_POST['submit'])){
        ...
        if($select->rowCount()>0){
            ...
            if($pass != $cpass){
                ...
                $insert = $conn->prepare('INSERT INTO pengguna (nama, email, password, image, user_type) VALUES (?, ?, ?, ?,?)');
                $insert->execute([$nama, $email, $pass, $image, 'admin']);
...
<body>
    ...
    <section class="form-container">
        <form enctype="multipart/form-data" method="post">
            ...
            <input type="submit" name="submit" value="Insert New Admin" class="btn">
        </form>
    </section>
</body>
</html>