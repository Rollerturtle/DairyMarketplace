...
if(isset($_POST['update_qty'])){
   ...
   $p_qty = $_POST['p_qty'];
   $update_qty = $conn->prepare("UPDATE keranjang SET jumlah = ? WHERE id = ?");
...
<section class="shopping-cart">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="flex-btn">
         <input type="number" min="1" value="<?= $fetch_cart['jumlah']; ?>" class="qty" name="p_qty">
         <input type="submit" value="update" name="update_qty" class="option-btn">
      </div>
      <div class="sub-total"> sub total : <span>Rp<?= $sub_total = ($fetch_cart['harga'] * $fetch_cart['jumlah']); ?></span> </div>
   </form>
   <?php
   ...
   <div class="cart-total">
      ...
      <a href="catalog.php" class="option-btn">continue shopping</a>
