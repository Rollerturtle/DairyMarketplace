...
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      ...
      <div class="name"><?= $fetch_wishlist['nama']; ?></div>
      <div class="price">Rp<?= $fetch_wishlist['harga']; ?>/-</div>
      <input type="number" min="1" value="1" class="qty" name="p_qty">
      <input type="hidden" name="pid" value="<?= $fetch_wishlist['pid']; ?>">
      <input type="hidden" name="p_name" value="<?= $fetch_wishlist['nama']; ?>">
      <input type="hidden" name="p_price" value="<?= $fetch_wishlist['harga']; ?>">
      <input type="hidden" name="p_image" value="<?= $fetch_wishlist['image']; ?>">
      <input type="submit" value="add to cart" name="add_to_cart" class="btn">
   </form>
   <?php
      $grand_total += $fetch_wishlist['harga'];
      }
   }else{
